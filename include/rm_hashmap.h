...
{                                                                                                                                                  	\
	...
	*/                                                                                                                                             	\
	...
	public_interface_get rm_size count_threshold;                                                                                                  	\
                                                                                                                                                   	\
	/*                                                                                                                                             	\
		Inline a single entry into the base data structure itself.                                                                                 	\
		That is cheap and allows us to go without an extra malloc(...) for bucket count 1.                                                         	\
		1 is minimum and will also be used if the user asks for bucket count 0.                                                                    	\
	*/                                                                                                                                             	\
	rm_##name##_hashmap_entry buckets_lite;                                                                                                        	\
} rm_##name##_hashmap;                                                                                                                             	\
                                                                                                                                                   	\
/* An iteration function that allows to process all key-value pairs in a hashmap */                                                                	\
typedef rm_void (*rm_##name##_hashmap_iteration_func)(const rm_##name##_hashmap*, rm_##name##_hashmap_key, rm_##name##_hashmap_value, rm_void*);   	\
                                                                                                                                                   	\
/* A debug version of the iteration function */                                                                                                    	\
typedef rm_void (*rm_##name##_hashmap_debug_iteration_func)(const rm_##name##_hashmap*, rm_##name##_hashmap_entry_const_ptr, rm_bool, rm_void*);
...
//Nice default values for initial bucket count (must be a PoT > 1) and load factor:
#define RM_HASHMAP_DEFAULT_INITIAL_BUCKETS_COUNT 16
...
({                                                                                                                                           	\
	...
	rm_size _buckets_count = (buckets_count);                                                                                                	\
                                                                                                                                             	\
	(_buckets_count == RM_HASHMAP_MAX_BUCKETS_COUNT) ? SIZE_MAX : (rm_size)rm_clamp(_load_factor * _buckets_count, 1.0, (rm_double)SIZE_MAX);	\
})
...
({                                                                                                                   	\
	...
	*/                                                                                                               	\
	...
	(_index == RM_HASHMAP_NO_MORE_ENTRIES) ? null : (rm_vec_ptr_at(&(map)->collision_entries, 0) + (_index - 1));    	\
})
...
*/                                                                                                                                                                                                	\
rm_void rm_##name##_hashmap_init(rm_##name##_hashmap* map);                                                                                                                                       	\
...
*/                                                                                                                                                                                                	\
rm_##name##_hashmap_value rm_##name##_hashmap_get(const rm_##name##_hashmap* map, rm_##name##_hashmap_key key, rm_##name##_hashmap_value default_value);                                          	\
                                                                                                                                                                                                  	\
/*                                                                                                                                                                                                	\
	Try to retrieve the value for the given key.                                                                                                                                                  	\
...
*/                                                                                                                                                                                                	\
rm_void rm_##name##_hashmap_for_each(const rm_##name##_hashmap* map, rm_##name##_hashmap_iteration_func iteration_func, rm_void* context);                                                        	\
                                                                                                                                                                                                  	\
/*                                                                                                                                                                                                	\
...
*/                                                                                                                                                                                                	\
rm_void rm_##name##_hashmap_debug_for_each(const rm_##name##_hashmap* map, rm_##name##_hashmap_debug_iteration_func debug_iteration_func, rm_void* context);
...
{                                                                                                                                                                                                        	\
	...
	rm_size new_count_threshold = rm_hashmap_calculate_count_threshold(map->load_factor, new_buckets_count);                                                                                             	\
                                                                                                                                                                                                         	\
	/* Are we still inside the lite bucket? */                                                                                                                                                           	\
	if (rm_unlikely(map->buckets_count == 1))                                                                                                                                                            	\
	{                                                                                                                                                                                                    	\
		/*                                                                                                                                                                                               	\
			The new number of buckets is always 2 at this point.                                                                                                                                         	\
			Allocate the new table on the heap and zero it out.                                                                                                                                          	\
		*/                                                                                                                                                                                               	\
		map->buckets = (rm_##name##_hashmap_entry_ptr)rm_malloc_zero(2 * sizeof(rm_##name##_hashmap_entry));                                                                                             	\
                                                                                                                                                                                                         	\
		/*                                                                                                                                                                                               	\
			Move the single entry from the lite bucket to the start of the new table.                                                                                                                    	\
			This mimics the realloc semantics we use in all other cases.                                                                                                                                 	\
		*/                                                                                                                                                                                               	\
		map->buckets[0] = map->buckets_lite;                                                                                                                                                             	\
	}                                                                                                                                                                                                    	\
	else                                                                                                                                                                                                 	\
	{                                                                                                                                                                                                    	\
		/* Reallocate the table and zero the upper half out. */                                                                                                                                          	\
		map->buckets = (rm_##name##_hashmap_entry_ptr)rm_realloc(map->buckets, new_buckets_count * sizeof(rm_##name##_hashmap_entry));                                                                   	\
...
/*                                                                                                                                                                                                                                             	\
	...
	If the entry is (or would be) located at the bucket base, it is set to null.                                                                                                                                                               	\
                                                                                                                                                                                                                                               	\
	Passing null for "prev_ptr" is okay if these result is not needed.                                                                                                                                                                         	\
*/                                                                                                                                                                                                                                             	\
...
static inline rm_void rm_##name##_hashmap_unref_entry(const rm_##name##_hashmap* map, rm_##name##_hashmap_key key, rm_##name##_hashmap_value value, rm_void* context);	\
                                                                                                                                                                      	\
static inline rm_void rm_##name##_hashmap_unref_entry(const rm_##name##_hashmap* map, rm_##name##_hashmap_key key, rm_##name##_hashmap_value value, rm_void* context) 	\
{                                                                                                                                                                     	\
	rm_unused(map);                                                                                                                                                   	\
...
//********************************************
//	Generic function definitions (public)
//********************************************
...
rm_void rm_##name##_hashmap_init(rm_##name##_hashmap* map)                                                     	\
{                                                                                                              	\
	/* Use nice default values. */                                                                             	\
	rm_##name##_hashmap_init_ex(map, RM_HASHMAP_DEFAULT_INITIAL_BUCKETS_COUNT, RM_HASHMAP_DEFAULT_LOAD_FACTOR);	\
}
...
{                                                                                                                                                     	\
	...
	rm_precond(load_factor >= 0, "Invalid load factor: %lf", load_factor);                                                                            	\
                                                                                                                                                      	\
	/* Can we use the lite bucket? */                                                                                                                 	\
	if (initial_buckets_count <= 1)                                                                                                                   	\
	{                                                                                                                                                 	\
		map->buckets_lite.hash = RM_HASHMAP_HASH_EMPTY;                                                                                               	\
		map->buckets_lite.next_entry_index = RM_HASHMAP_NO_MORE_ENTRIES;                                                                              	\
                                                                                                                                                      	\
		map->buckets = &map->buckets_lite;                                                                                                            	\
		map->buckets_count = 1;                                                                                                                       	\
	}                                                                                                                                                 	\
	else                                                                                                                                              	\
	{                                                                                                                                                 	\
		/* Select the first PoT >= RM_HASHMAP_DEFAULT_INITIAL_BUCKETS_COUNT that is sufficient. */                                                    	\
		map->buckets_count = RM_HASHMAP_DEFAULT_INITIAL_BUCKETS_COUNT;                                                                                	\
                                                                                                                                                      	\
		...
		*/                                                                                                                                            	\
		map->buckets = (rm_##name##_hashmap_entry_ptr)rm_malloc_zero(map->buckets_count * sizeof(rm_##name##_hashmap_entry));                         	\
	}                                                                                                                                                 	\
                                                                                                                                                      	\
...
{                                                                                                       	\
	...
	rm_##name##_hashmap_unref_all(map);                                                                 	\
                                                                                                        	\
	/*                                                                                                  	\
		Free the buckets if we are not inside the lite bucket.                                          	\
		The lite bucket is located inside the hasmap struct itself, freeing it would be a grave mistake.	\
	*/                                                                                                  	\
	if (map->buckets_count > 1)                                                                         	\
	{                                                                                                   	\
		rm_free(map->buckets);                                                                          	\
	}                                                                                                   	\
                                                                                                        	\
...
{                                                                                                                                                                                                	\
	...
	if (entry)                                                                                                                                                                                   	\
	{                                                                                                                                                                                            	\
		/* Assign the old value (the user has to unref it manually if we replace it). */                                                                                                         	\
		*old_value_ptr = entry->value;                                                                                                                                                           	\
                                                                                                                                                                                                 	\
	...
	*/                                                                                                                                                                                           	\
	...
	/*                                                                                                                                                                                           	\
		...
		*Caution*: At the end of this statement, prev is poisoned and must not be used anymore!                                                                                                  	\
	...
	*/                                                                                                                                                                                           	\
	...
	{                                                                                                                                                                                            	\
		...
		{                                                                                                                                                                                        	\
			entry = rm_hashmap_get_entry_ptr(map, map->supply_list);                                                                                                                             	\
			map->supply_list = entry->next_entry_index;                                                                                                                                          	\
                                                                                                                                                                                                 	\
			/* Calculate the index of this new entry and let the previous one point to it. */                                                                                                    	\
			prev->next_entry_index = rm_hashmap_get_entry_index(map, entry);                                                                                                                     	\
		}                                                                                                                                                                                        	\
		else                                                                                                                                                                                     	\
		{                                                                                                                                                                                        	\
			/* *Important*: Fix the previous entry *first*! Kind of hacky ... */                                                                                                                 	\
...
{                                                                                                                                        	\
	...
	{                                                                                                                                    	\
		...
		do                                                                                                                               	\
		{                                                                                                                                	\
			/* Invoke the iteration function and pass the user's context. */                                                             	\
			iteration_func(map, entry->key, entry->value, context);                                                                      	\
		} while ((entry = rm_hashmap_get_entry_ptr(map, entry->next_entry_index)) != null);                                              	\
	}                                                                                                                                    	\
}
	...
	{                                                                                                                                                      	\
		...
		{                                                                                                                                                  	\
			continue;                                                                                                                                      	\
                                                                                                                                                           	...
                                                                                                                                                           	\
		/* Traverse the whole bucket. */                                                                                                                   	\
		debug_iteration_func(map, entry, false, context);                                                                                                  	\
                                                                                                                                                           	\
		while ((entry = rm_hashmap_get_entry_ptr(map, entry->next_entry_index)) != null)                                                                   	\
		{                                                                                                                                                  	\
			debug_iteration_func(map, entry, true, context);                                                                                               	\
		}                                                                                                                                                  	\
	}                                                                                                                                                      	\
}
