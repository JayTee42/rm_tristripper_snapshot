...
static rm_tristripper_tri* rm_tristripper_collect_strip_loop(rm_tristripper_tri* curr_tri, rm_size curr_index_to_prev, rm_size prev_entrance_vertex_id, rm_size curr_entrance_vertex_id, rm_tristripper_id_vec* strip_ids_vec);
